...
try{
  ...
  const r=await page.evaluate(async()=>{
    ...
    const career=await import('./src/engine/career.js?v=2.0.0');
    const retire=await import('./src/ui/retire.js?v=2.0.0');
    const share=await import('./src/ui/share-image.js?v=2.0.0');
    ...
    const dom=await import('./src/ui/dom.js?v=2.0.0');
    dom.board(1);
