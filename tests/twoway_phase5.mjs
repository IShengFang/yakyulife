...
try{
  ...
  const r=await page.evaluate(async()=>{
    ...
    const career=await import('./src/engine/career.js?v=2.0.8');
    const retire=await import('./src/ui/retire.js?v=2.0.8');
    const share=await import('./src/ui/share-image.js?v=2.0.8');
