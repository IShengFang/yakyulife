...
try{
  ...
  const r=await page.evaluate(async()=>{
    ...
    const rng=await import('./src/core/rng.js?v=2.0.8');
    const season=await import('./src/engine/season.js?v=2.0.8');
    const {LV,envWhip,envLeagueOps,hrCapRate}=await import('./src/data/teams.js?v=2.0.8');
    const th=await import('./src/data/thresholds.js?v=2.0.8');
