...
import {$, teamChip} from './dom.js?v=2.0.7';
import {TRAIT_KEYS, TRAIT_N, TRAIT_FX, legendTraitNames, rainbowTraitNames, pitcherTCNames, hitterTCNames, nitenichiNames} from '../data/traits.js?v=2.0.7';
import {TEAM_COLOR, teamNick} from '../data/teams.js?v=2.0.7';
