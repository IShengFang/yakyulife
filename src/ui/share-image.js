...
import {SEED} from '../core/rng.js?v=2.0.4';
import {APP_VER, OFFICIAL_HOST} from '../config.js?v=2.0.4';
import {TEAM_COLOR, LG_N} from '../data/teams.js?v=2.0.4';
import {RP_TICKS} from '../data/economy.js?v=2.0.4';
import {TRAIT_KEYS} from '../data/traits.js?v=2.0.4';
import {$, teamChip, modalOpen, modalClose} from './dom.js?v=2.0.4';
import {THEME_NAMES} from './prefs.js?v=2.0.4';
import {traitNames, traitColorRank} from './traits.js?v=2.0.4';
import {fmtMoney} from '../engine/contract.js?v=2.0.4';
import {twoWayView} from '../engine/career.js?v=2.0.4';
import {rpTagline, rpFamily, RP_F3, RP_F2, rpCumData, rpIntlData, rpHonorItems, rpOrgOf, rpProData, rpSalaryData, championshipYear} from './retire.js?v=2.0.4';
...
export function renderShareImage(evals,picks,opt){
  ...
  function tagColor(o){ /* keep in sync with traitTagStyle() + the .tag defaults */
    ...
    if(o.key==='legend'||o.key==='taiwan'||o.key==='intlace'||o.key==='pitcherTC'||o.key==='hitterTC'||o.key==='nitenichi')return {bg:'#3a2c05',bd:'#ffc95c',fg:'#ffe08a'}; /* 金 */
