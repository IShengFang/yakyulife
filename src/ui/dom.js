...
import {APP_VER, SPONSOR_URL} from '../config.js?v=2.0.10';
import {renderTraits, traitNames} from './traits.js?v=2.0.10';
import {clearAlloc, allocFullClose} from './alloc.js?v=2.0.10';
import {themeModal, applyBigText, applyMobileUI} from './prefs.js?v=2.0.10';
import {DPN, POSN} from '../data/abilities.js?v=2.0.10';
import {TEAM_COLOR, LV} from '../data/teams.js?v=2.0.10';
import {TRAIT_KEYS, TRAIT_FX} from '../data/traits.js?v=2.0.10';
import {playerName, stageLabel} from '../core/state.js?v=2.0.10';
import {salParts, fmtMoney} from '../engine/contract.js?v=2.0.10';
import {roleN, fmtIP, slgOf, baseballERA, baseballWHIP, pitG} from '../engine/season.js?v=2.0.10';
import {honorGroups, honorSections, yearRanges, twoWayView, twHasPit, twHasBat} from '../engine/career.js?v=2.0.10';
import {isChampionshipYear} from '../engine/championship.js?v=2.0.10';
import {playerType, ovr} from '../engine/ability.js?v=2.0.10';
