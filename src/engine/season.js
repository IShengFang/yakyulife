...
import {tjAccrue, tjGamble} from './injury.js?v=2.0.6';
/* temporary scaffold until awards/intl/contract/flow are extracted */
import {demotionAudit} from './contract.js?v=2.0.6';
import {awards} from './awards.js?v=2.0.6';
import {maybeIntl} from './intl.js?v=2.0.6';
