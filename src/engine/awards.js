...
import {chance, clamp} from '../core/rng.js?v=2.0.4';
import {DPN, GLOVE_TH, GLOVE_K} from '../data/abilities.js?v=2.0.4';
import {LV} from '../data/teams.js?v=2.0.4';
import {AWARD_TH, starTh} from '../data/thresholds.js?v=2.0.4';
import {card} from '../ui/dom.js?v=2.0.4';
import {tlNote} from '../ui/timeline.js?v=2.0.4';
import {isSP, slgOf, baseballERA, pitG} from './season.js?v=2.0.4';
import {isCareerScoringAward, splitBySide} from './award-rules.js?v=2.0.4';
