...
import {chance, clamp} from '../core/rng.js?v=2.0.10';
import {DPN, GLOVE_TH, GLOVE_K} from '../data/abilities.js?v=2.0.10';
import {LV} from '../data/teams.js?v=2.0.10';
import {AWARD_TH, starTh} from '../data/thresholds.js?v=2.0.10';
import {card} from '../ui/dom.js?v=2.0.10';
import {tlNote} from '../ui/timeline.js?v=2.0.10';
import {isSP, slgOf, baseballERA, pitG} from './season.js?v=2.0.10';
import {isCareerScoringAward, splitBySide} from './award-rules.js?v=2.0.10';
