...
import {R, ri, pick, chance, clamp, SEED} from '../core/rng.js?v=2.0.7';
import {LV, PATHS, CPBL_TEAMS, NPB_TEAMS, MLB_TEAMS} from '../data/teams.js?v=2.0.7';
import {AMA_ANNUAL, LEVEL_MIN_ANNUAL, MLB_SERVICE_MINOR_MIN} from '../data/economy.js?v=2.0.7';
import {card, choose, board} from '../ui/dom.js?v=2.0.7';
import {tlNote} from '../ui/timeline.js?v=2.0.7';
import {ovr} from './ability.js?v=2.0.7';
import {injuryMarketStatus} from './injury.js?v=2.0.7';
import {hasActiveFranchise} from './tenure.js?v=2.0.7';
import {seasonSalaryRating, currentSalaryRating} from './season.js?v=2.0.7';
import {capTeam} from './career.js?v=2.0.7';
import {traitCard, removeTrait} from '../flow/events.js?v=2.0.7';
import {advance} from './draft.js?v=2.0.7';
import {finishContractYear} from '../flow/phases.js?v=2.0.7';
...
/* ───────── 合約金額的外幣參考值 ─────────
   ...
   匯率是寫死的整數，刻意不跟真實匯率連動：同一份合約隔天回頭看，數字不該變，
   而且這只是括號裡的參考值，沒有精確到小數點的必要——
   1 美元 = 30 台幣、1 台幣 = 5 日圓（2026-09 的實際匯率約 31.98 與 4.85，取整好記）。
   幣別看層級的 org：MiLB（含 1A~3A 與大聯盟）記美元、NPB 記日圓、中職不加註。 */
export const FX={MiLB:{rate:30,unit:'美元'},NPB:{rate:0.2,unit:'日圓'}};
