...
import {R, ri, pick, chance, clamp} from '../core/rng.js?v=2.0.0';
...
import {addAb} from './ability.js?v=2.0.0';
import {isSP, pitG, TW_EFFORT} from './season.js?v=2.0.0';
import {removeTrait} from '../flow/events.js?v=2.0.0';
