...
import {LV, envRate, envAvg, envHR9, ENV_K} from '../data/teams.js?v=2.0.5';
import {card, choose, board} from '../ui/dom.js?v=2.0.5';
import {tlNote} from '../ui/timeline.js?v=2.0.5';
import {isSP, fmtIP, outsFromIP, ipFromOuts, normalizeIP, baseballERA} from './season.js?v=2.0.5';
import {ovr} from './ability.js?v=2.0.5';
import {intlFinishIndex} from './championship.js?v=2.0.5';
import {checkChampionTrait} from '../flow/events.js?v=2.0.5';
