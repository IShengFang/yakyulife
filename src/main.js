import {SEED, setSeed, seedInit} from './core/rng.js?v=2.0.8';
import {S, setS, newState} from './core/state.js?v=2.0.8';
import {APP_VER} from './config.js?v=2.0.8';
import {POSN} from './data/abilities.js?v=2.0.8';
import {LV} from './data/teams.js?v=2.0.8';
import {$, card, modalClose, actToggleSync} from './ui/dom.js?v=2.0.8';
import {THEME_KEY, BIG_KEY, applyTheme, applyMobileUI, applyBigText, updDispSum} from './ui/prefs.js?v=2.0.8';
import {allocFullClose} from './ui/alloc.js?v=2.0.8';
import {TL, resetTL, renderTimeline, tlScrollTo} from './ui/timeline.js?v=2.0.8';
import {startYear} from './flow/phases.js?v=2.0.8';
...
bindPosSeg();
/* ── 二刀流入口 ──
   v2.0.8 起就是守位列的第五顆按鈕：它跟其他四個互斥、行為一樣，沒有理由做成
