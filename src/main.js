import {SEED, setSeed, seedInit} from './core/rng.js?v=2.0.0';
import {S, setS, newState} from './core/state.js?v=2.0.0';
import {APP_VER} from './config.js?v=2.0.0';
import {POSN} from './data/abilities.js?v=2.0.0';
import {LV} from './data/teams.js?v=2.0.0';
import {$, card, modalClose, actToggleSync} from './ui/dom.js?v=2.0.0';
import {THEME_KEY, BIG_KEY, applyTheme, applyMobileUI, applyBigText, updDispSum} from './ui/prefs.js?v=2.0.0';
import {allocFullClose} from './ui/alloc.js?v=2.0.0';
import {TL, resetTL, renderTimeline, tlScrollTo} from './ui/timeline.js?v=2.0.0';
import {startYear} from './flow/phases.js?v=2.0.0';
