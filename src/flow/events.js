...
import {R, pick, chance, clamp} from '../core/rng.js?v=2.0.3';
import {ABL, POS_AB} from '../data/abilities.js?v=2.0.3';
import {LV} from '../data/teams.js?v=2.0.3';
import {EVENTS, EVENT_CATEGORY_NAMES, EVENT_COMBINATIONS, EVENT_ROUTES, eventInjuryRisk} from '../data/events.js?v=2.0.3';
import {card, choose, board} from '../ui/dom.js?v=2.0.3';
import {addAb, statBonus, statBonusTxt, abGainTxt, ovr} from '../engine/ability.js?v=2.0.3';
import {majorChampionshipCount} from '../engine/championship.js?v=2.0.3';
