...
/* ---------- 二刀流資格檢查 ----------
   ...
   門檻是「弱側的 ovr 低於該層級 min − TW_BAR」。歷史沿革：
     ...
     v2.0.9 二刀流綜評重算之後又掉到 11.6%——綜評變高讓他們更快跳過日職二軍，
       ...
       在大聯盟 0.8%→4.8%。同樣本數重新掃一次（N=2,500）：
         min−0.5 11.6% ／ min−0.2 14.0% ／ min−0 15.5% ← 現在 ／ min+0.3 18.5%
   收到 min−0 之後，這條規則終於可以照字面講：
   站穩一季之後，弱側要能自己達到該層級的最低水準——不多給任何寬限。
